    ...
    _transform(chunk, encoding, callback) {
        try {
            ...
            const dataset = this.rdf.dataset([...context.dataset]
                ...
                .map(quad => {
                return this.rdf.quad(quad.subject.termType === 'NamedNode' ? context.observation : quad.subject, quad.predicate, quad.object);
            }));
...
function toObservation({ blacklist, dimensions, observation, observations, observer, useDate, dateProperty, useIndex, } = {}) {
